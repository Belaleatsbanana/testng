...
void main() throws InterruptedException {
    ...
    try {
        ...
        wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(.//*[normalize-space(text()) and normalize-space(.)='Month'])[1]/following::div[4]"))).click();
        Thread.sleep(500);
        ...
        // Step 12: check success
        WebElement successElement = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("/html/body/div[1]/div/div[5]/div/div/div")));
